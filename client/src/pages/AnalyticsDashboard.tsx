...
const AnalyticsDashboard: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Recent Activity and Time Range Selection */}
        ...
        <div className="w-full lg:w-1/3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select time range for analytics</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      {/* Document and Issue Analytics */}
      <h2 className="text-2xl font-bold mb-4">Document Analytics</h2>
